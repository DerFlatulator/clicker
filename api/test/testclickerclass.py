...
class ClickerClassTest(test.APITestCase):
    ...
    def test_class_name_unique_PATCH(self):
        ...
        self.assertTrue('id' in response2.data,
                        msg='An id field should be returned')
        id2 = response2.data['id']

        response3 = self.client.put('/api/class/{}/'.format(id2), {
            'class_name': 'c'
        })
    ...
    def test_can_DELETE(self):
        ...
        response2 = self.client.delete('/api/class/{}/'.format(id1))
    ...
    def test_GET(self):
        ...
        response3 = self.client.get('/api/class/{}/'.format(id1))
